...
<div class="row">
    <div class="col-12 col-md-3 mb-4 mb-md-0">
        <div class="card text-bg-primary">
            ...
            <form class="card-body" action="{{ route("rooms.index") }}">
                <div class="mb-3">
                        ...
                        <div class="col-12 col-md-9">
                            <div class="row">
                                <div class="col-12 col-md-9 mt-2 mt-md-0">
                                    <p class="fw-bold mb-3">{{ $room->name }}</p>
                                    
                                    <p class="mb-3">{{ $room->description }}</p>
                                    
                                    <p class="mb-3">{{ $room->beds }}</p>
                                    
                                    <p class="mb-3">Adults - {{ $room->adults }}, Children - {{ $room->children }}</p>
                                ...
                                <div class="room-right mt-3 mt-md-0 col-12 col-md-3 d-flex gap-2 align-items-start align-items-md-center justify-content-start justify-content-md-center flex-column border-start">
                                    <h3>₹ {{ $room->price }}</h3>
